...
const Header = () => {
  ...
  "
      >
        <div className="lg:container sm:container mx-auto w-full flex flex-wrap items-center justify-end px-6">
          <button
    ...
    "
      ...
      "
            ...
            {/* Left links */}
            <ul className="navbar-nav flex flex-col justify-end pl-0 list-style-none mr-auto w-full">
