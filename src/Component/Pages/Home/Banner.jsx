...
const Banner = () => {
    ...
    return (
        <section className='bg-cover bg-center bg-no-repeat lg:container lg:mx-auto mx-5' style={{"backgroundImage": `url(${bgImage})`}}>
            <div className='flex md:flex-row flex-col lg:grid-cols-2 items-center justify-center py-40 gap-4 px-5'>
